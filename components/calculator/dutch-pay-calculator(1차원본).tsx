...
export function DutchPayCalculator() {
  ...
  const quickSettlementAmount = Math.max(0, quickTotalAmount - quickDiscountAmount);
  ...
  const detailSettlementAmount = Math.max(0, detailTotalAmount - detailDiscountAmount);
  const detailItemDifferenceAmount = detailSettlementAmount - detailItemTotalAmount;
  const canGoDetailItemsStep =
    detailTotalAmount > 0 && detailDiscountAmount <= detailTotalAmount && !!mainPayerId;
  ...
  const quickValidationErrors = useMemo(() => {
    ...
    if (quickDiscountAmount > quickTotalAmount) {
  ...
  const detailValidationErrors = useMemo(() => {
    ...
    if (detailDiscountAmount > detailTotalAmount) {
          ...
          <div className="space-y-6">
            ...
            <section className="p-4 bg-muted/50 rounded-xl space-y-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">-{quickDiscountAmount.toLocaleString()}원</span>
              </div>
            ...
            {detailStep === "total" && (
              <div className="space-y-6">
                ...
                <section className="p-4 bg-muted/50 rounded-xl space-y-2">
                  ...
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">할인 금액</span>
                    <span className="font-medium">-{detailDiscountAmount.toLocaleString()}원</span>
                  </div>
                  <div className="flex justify-between text-sm pt-2 border-t border-border">
                ...
                {renderValidationErrors(
                  detailTotalAmount <= 0
                    ...
                    : detailDiscountAmount > detailTotalAmount
